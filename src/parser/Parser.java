...
public class Parser implements ParserConstants {
  ...
  static final public SyntaxElement Expression() throws ParseException {SyntaxElement e1, e2; Token n1, n2;
    ...
    case 5:{
      ...
      jj_consume_token(8);
      e1 = Expression();
{if ("" != null) return new Receive(new ParserName(n2.toString()),
    ...
    case 6:{
      ...
      jj_consume_token(8);
      e1 = Expression();
{if ("" != null) return new Send(new ParserName(n2.toString()),
                    new ParserName(n1.toString()), e1);}
      break;
      }
    case 9:{
      ...
      jj_consume_token(10);
      e2 = Expression();
{if ("" != null) return new Parallel(e1, e2);}
      break;
      }
    case 11:{
      jj_consume_token(11);
      ...
      jj_consume_token(12);
      e1 = Expression();
{if ("" != null) return new Restrict(new ParserName(n1.toString()), e1);}
      break;
      }
    case 13:{
      jj_consume_token(13);
      e1 = Expression();
{if ("" != null) return new Replicate(e1);}
      break;
      }
    case 14:{
      jj_consume_token(14);
{if ("" != null) return new Done();}
      break;
      }
    default:
      jj_la1[0] = jj_gen;
